        ...
        <View style={styles.truckCardTop}>
          <View style={styles.plateWrap}>
            <View style={[styles.iconCircle, { backgroundColor: C.primaryContainer }]}>
              <MaterialCommunityIcons name={(type?.icon as any) ?? 'truck'} size={22} color={C.primary} />
            </View>
            <View>
        ...
        <View style={[styles.modalSheet, { backgroundColor: C.surface }]}>
            ...
            {TRUCK_TYPES.map(tt => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  type === tt.value && { backgroundColor: C.primary, borderColor: C.primary },
                ]}
                onPress={() => setType(tt.value)}
              >
                <MaterialCommunityIcons
                  name={tt.icon as any} size={18}
                  color={type === tt.value ? C.onPrimary : C.primary}
                />
                <Text style={[
                  styles.typeChipText,
                  { color: C.primary },
                  type === tt.value && { color: C.onPrimary },
                ]}>
                  {tt.label}
                </Text>
              </TouchableOpacity>
          ...
          >
            {saving
              ...
              : <Text style={[styles.saveBtnText, { color: C.onPrimary }]}>{t('common_save')}</Text>}
          </TouchableOpacity>
...
export default function TruckScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: C.background }]}>
      ...
      <FAB
        icon="plus"
        style={[styles.fab, { bottom: insets.bottom + 20, backgroundColor: C.primary }]}
