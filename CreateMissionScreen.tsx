          ...
          {step === 2 && (
            <View>
              ...
              <View style={css.card}>
                ...
                {/* Toggle fragile */}
                <View style={css.fragileRow}>
                  <MaterialCommunityIcons name="alert-decagram-outline" size={20} color={isFragile ? '#E65100' : '#9E9E9E'} />
                  <Text style={[css.fragileLabel, isFragile && { color: '#E65100', fontWeight: '700' }]}>
                    Marchandise fragile
                  </Text>
                  <Switch
                    value={isFragile}
            ...
            <View>
              ...
              <View style={css.card}>
                <View style={css.cardHeader}>
                  ...
                  <Text style={css.cardTitle}>Type de mission</Text>
                </View>
              ...
              <View style={css.card}>
                <View style={css.cardHeader}>
                  ...
                  <Text style={css.cardTitle}>Date de prise en charge</Text>
                </View>
                <TouchableOpacity
                  style={css.datePickerBtn}
                ...
                >
                  <MaterialCommunityIcons
                    name="calendar"
                    size={20}
                    color={pickupDate ? '#1B5E20' : '#9E9E9E'}
                  />
                  <Text style={[css.datePickerText, pickupDate && { color: '#212121', fontWeight: '600' }]}>
                    {pickupDate
              ...
              <View style={css.summaryCard}>
                <Text style={css.summaryTitle}>Simulation de prix</Text>

                {distanceKm && (
                  <View style={css.summaryRow}>
                    <Text style={css.summaryKey}>Distance estimée</Text>
                ...
                {missionType === 'EXPRESS' && expressExtra > 0 && (
                  <>
                    <View style={css.summaryRow}>
                      <Text style={css.summaryKey}>Base</Text>
                      <Text style={css.summaryVal}>{basePrice.toLocaleString('fr-FR')} FCFA</Text>
                    </View>
                    <View style={css.summaryRow}>
                      <Text style={css.summaryKey}>Surcharge Express (+{EXPRESS_SURCHARGE_PCT * 100}%)</Text>
                ...
                <View style={[css.summaryRow, css.summaryTotalRow]}>
                  <Text style={css.summaryTotalKey}>Prix total</Text>
                  <Text style={css.summaryTotalVal}>{totalPrice > 0 ? totalPrice.toLocaleString('fr-FR') : '—'} FCFA</Text>
                </View>

                <View style={css.summaryRow}>
                  <Text style={css.summaryKey}>1ère tranche (à l'acceptation)</Text>
                  <Text style={[css.summaryVal, { color: '#0277BD', fontWeight: '800' }]}>
...
const css = StyleSheet.create({
  ...
  fragileLabel: { flex: 1, fontSize: 13, color: '#9E9E9E' },
  ...
  datePickerText: { flex: 1, fontSize: 14, color: '#9E9E9E' },
  dateHint: { fontSize: 11, color: '#9E9E9E', fontStyle: 'italic' },
  summaryCard: {
  ...
  summaryKey: { fontSize: 13, color: '#616161', flex: 1 },
  ...
  recapText: { fontSize: 13, color: '#424242', flex: 1 },
  infoCard: {
