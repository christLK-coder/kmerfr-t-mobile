...
const TX_COLORS: Record<string, string> = {
  DEPOSIT: '#00897B', RELEASE: '#2E7D32', REFUND: '#F57F17', COMMISSION: '#E65100',
};
...
export default function AdminFinanceScreen() {
  ...
  return (
    <View style={[s.root, { backgroundColor: C.background }]}>
      <View style={[s.header, { paddingTop: insets.top + 8, backgroundColor: C.primary }]}>
      ...
      >
        ...
        >
          <View style={s.policyHeader}>
            <MaterialCommunityIcons name="cog-outline" size={20} color={C.primary} />
        ...
        {showPolicy && (
          <View style={[s.policyForm, { backgroundColor: C.surface }]}>
            ...
            <Button mode="contained" onPress={savePolicy} loading={policyLoading}
              style={{ backgroundColor: C.primary, borderRadius: 10, marginTop: 8 }}>
              Enregistrer
            </Button>
          </View>
        )}
